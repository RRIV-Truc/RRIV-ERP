...
from modules.spm_gv.routes import spmgv_bp
app.register_blueprint(spmgv_bp)
...
VALID_APPS = [
    ...
    'baocao', 'thongbao', 'phanquyen', 'phonghop', 'tbkl', 'spmgv'
]
...
def show_app(app_name):
    ...
    if app_name == 'spmgv':
        pages = (
            os.getenv('SPM_GV_PAGES_URL') or 'https://rriv-spmgv.qm-rriv.workers.dev'
        ).strip().rstrip('/')
