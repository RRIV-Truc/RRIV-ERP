-- ============================================================
-- Giao viec TT SPM - chay 1 lan tren Supabase SQL Editor
-- (New query -> dan toan bo -> Run)
-- An toan: IF NOT EXISTS / ON CONFLICT, co the chay lai.
-- ============================================================
...
-- ---------- Patch v2 (cot bao cao + Hiền / Kiem tra cheo) ----------
